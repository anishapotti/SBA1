...
public class ApprovedLoan {
	...
	public ApprovedLoan(String applno) {
		super();
		this.applno = applno;
	...
	public ApprovedLoan(String applno,int amotsanctioned,	int loanterm,	String psd,	String lcd,	int emi,	int termpaymentamount, float interestRate, String status) {
		super();
		this.applno = applno;
		this.amotsanctioned = amotsanctioned;
		this.loanterm = loanterm;
	...
	public int getTermpaymentamount() {
		return termpaymentamount;
	}

	public void setTermpaymentamount(int termpaymentamount) {
		this.termpaymentamount = termpaymentamount;
	}
